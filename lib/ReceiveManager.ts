...
export async function UpdateReceives(request: Request) { }
export async function UpdateReceive(request: Request) {
    let range = "Receive!A:C";
    try {
        ...
        range = `Receive!A${insertRow}:C${insertRow}`;
